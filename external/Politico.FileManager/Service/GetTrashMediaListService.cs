...
{
    public sealed class GetTrashMediaListService : IGetTrashMediaListService
    {
        private readonly IAppDbContext _db;

        public GetTrashMediaListService(IAppDbContext db) => _db = db;

        public async Task<IReadOnlyList<MediaItemDto>> GetTrashAsync(CancellationToken ct = default)
        {
