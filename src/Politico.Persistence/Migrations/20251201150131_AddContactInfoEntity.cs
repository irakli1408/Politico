...
{
    /// <inheritdoc />
    public partial class AddContactInfoEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactInfoLocales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContactInfoLocales_ContactInfos_ContactInfoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactInfoLocales_ContactInfoId",
                table: "ContactInfoLocales",
